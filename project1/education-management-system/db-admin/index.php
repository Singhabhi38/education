...
?>
	...
	<div class="ui-layout-north">
		<div id="main_header">
			<a target="_blank" href="<?php echo $_SERVER['http_referer']?>"><img src="img/logo.png" class="logo" alt="MyWebSQL" width="45" height="38" border="0" /></a>
			<div class="title">
				<div class="main">Database Administration</div>
<!--				<div class="version">--><?php //echo __('version') . ' ' . APP_VERSION; ?><!--</div>-->
<!--				<div class="version">--><?php //echo 1; ?><!--</div>-->
			</div>
			<div class="info">
